...
$APIKey = "733B7031DCE0F4A53DFA4A89F52B9FF8"; // Go get your API here: http://steamcommunity.com/dev/apikey
		...
		<div class="top-box">
			...
			<!--Where the first picture is put in to display -->
				...
				<div class="middle-box">
					<p class="box-title">Server Kuralları</p>
					<hr class="blue-line2">
					...
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Birisi Sana Silah Tutarsa Kork Silah Çekme
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Build Kuralları Forumda Yazılı
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Kimseye Gerçek Adıyla Hitap Etme RP Adını Kullan.
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Herhangi Bir Sorunun Olursa veya Başka Bir Oyuncunun Hatasıyla Karşılaşırsan Calladmin Yazman Yeterli
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Forumumuzu Takip Etmeyi Unutmayın
						</td>
					</table>
